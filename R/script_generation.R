...
generate_repro_script <- function(script_file,
  ...
  script_lines <- c(
    ...
    paste0("# Generated by: ReproFlow v", packageVersion("ReproFlow")),
    "#",
  ...
  seed_registry <- .load_seed_registry(".reproflow/seed_registry.json")
  ...
  param_registry <- .load_param_registry(".reproflow/param_registry.json")
